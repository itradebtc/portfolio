      ...
      <div className='md:row-span-2 w-fit md:w-[40vw] md:mx-7'>
        ...
        <div className='pt-4 text-lg'>
            ...
            <ul className="flex gap-7">
                <li className='hover:scale-125 hover:ease-in duration-300 hover:text-[hsl(207,13%,34%)]'>
                <a href="https://www.linkedin.com/in/kelubia-urubusi-91a483269/" target='_blank' rel='noreferrer' title='My LinkedIn Page'>
                  <TiSocialLinkedin size={50} className='hover:ease-in duration-300 hover:scale-100 hover:text-[hsl(207,13%,34%)]' />
                </a> 
                    </li>
                <li className='hover:scale-125 hover:ease-in duration-300 hover:text-[hsl(207,13%,34%)]'>
                <a href="https://www.instagram.com/zaddy___1/" target='_blank' rel='noreferrer' title='My Instagram Page'>
                  <TiSocialInstagram size={50} className='hover:ease-in duration-300 hover:scale-100 hover:text-[hsl(207,13%,34%)]' />
                </a>
                </li>
                <li className='hover:scale-125 hover:ease-in duration-300 hover:text-[hsl(207,13%,34%)]'>
                <a href="https://twitter.com/murubz" target='_blank' rel='noreferrer' title='My Twitter Page'> 
                  <TiSocialTwitterCircular size={50} className='hover:ease-in duration-300 hover:scale-100 hover:text-[hsl(207,13%,34%)]' />
                </a>
                </li>
            </ul>
        </div>
